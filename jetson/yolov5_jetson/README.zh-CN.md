...
# Model
model = torch.hub.load("ultralytics/yolov5_jetson", "yolov5s")  # or yolov5n - yolov5x6, custom
...
model = torch.hub.load(
    "ultralytics/yolov5_jetson", "custom", "yolov5m-seg.pt"
...
```python
model = torch.hub.load(
    "ultralytics/yolov5_jetson", "custom", "yolov5s-cls.pt"
