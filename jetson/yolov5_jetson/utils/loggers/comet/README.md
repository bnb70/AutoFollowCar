...
export COMET_PROJECT_NAME=<Your Comet Project Name> # This will default to 'yolov5_jetson'
```
...
export COMET_MODEL_NAME=<your model name> #Set the name for the saved model. Defaults to yolov5_jetson
